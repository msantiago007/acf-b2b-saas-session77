...
VALUES
  ('00000000-0000-0000-0000-000000000002', 'Beta Team 1', 'First team at Beta'),
  ('00000000-0000-0000-0000-000000000002', 'Beta Team 2', 'Second team at Beta')
...
-- ============================================================
-- TEST 7: INSERT with RLS
-- ============================================================

-- Set to Org 1
SET LOCAL app.current_organization_id = '00000000-0000-0000-0000-000000000001';

-- Try to insert into Org 2 (should be blocked or filtered)
-- Note: This might fail or be filtered depending on policy
...
--   'free'
-- );
-- Expected: Blocked by RLS policy or inserted with current_organization_id

-- ============================================================
-- TEST 8: UPDATE with RLS
-- ============================================================
...
-- Verify Org 2 still exists
SELECT COUNT(*) AS org_2_exists
FROM organizations
WHERE id = '00000000-0000-0000-0000-000000000002';
-- Expected: 1 (Org 2 still exists, but you can't see it due to RLS)

-- Verify as service role (bypass RLS)
-- Note: This requires running with service_role permissions
-- SELECT COUNT(*) AS org_2_exists FROM organizations WHERE id = '...002';

-- ============================================================
-- TEST 10: Service Role Bypass (requires service_role)
-- ============================================================

-- Note: These queries only work when executed with service_role key
-- In Supabase SQL Editor, this runs as postgres role which bypasses RLS
